...
const RequisitionList = () => {
    ...
    const handleDownloadPDF = (requisition) => {
        const pdfData = {
            requisitionNumber: requisition.requisition_number || `REQ-${requisition.id?.slice(-8)}`,
            providerName: 'Dr. Merrick Reynolds, MD', // You might want to fetch this from provider data
            providerNPI: '1295302339',
            patientName: requisition.patient_name,
            patientDOB: requisition.patient_dob,
            patientPhone: requisition.patient_phone,
            medicaidId: requisition.medicaid_id,
            tests: requisition.tests || [],
            diagnosisCode: requisition.diagnosis_code,
            diagnosisDescription: requisition.diagnosis_description,
            specialInstructions: requisition.special_instructions
        };
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="flex flex-col items-end space-y-2">
                                        ...
                                        <div className="flex space-x-2">
                                            <button
                                                onClick={() => handleDownloadPDF(requisition)}
